# -*- coding: utf-8 -*-
#
# macho documentation build configuration file, created by
...
#sys.path.insert(0, os.getenv('macho_HOME'))
...
#import docs.scripts.macho
#import docs.scripts.macho_registration
#import docs.scripts.macho_diffusion
...
latex_documents = [
  (master_doc, 'macho.tex', u'macho Documentation',
   u'OCP', 'manual'),
]
...
man_pages = [
    (master_doc, 'macho', u'macho Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'macho', u'macho Documentation',
   author, 'macho', 'One line description of project.',
   'Miscellaneous'),
]
